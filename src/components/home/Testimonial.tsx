        ...
        <div className="mx-auto max-w-screen-lg px-4 py-8 lg:px-6 lg:py-16">
          ...
          <div className="flex w-full flex-col gap-4 lg:flex-row">
            {TESTIMONIALS.map((testimonial, index) => (
              <div
                key={index}
                className="flex w-full items-center justify-center rounded-xl border border-gray-500 bg-white/30 p-6 backdrop-blur dark:border-gray-400 dark:bg-black/30 lg:flex-row"
              >
                <div className={`flex h-full flex-col justify-between gap-4`}>
                  ...
                  <div className="flex items-center justify-end space-x-3 lg:justify-center">
